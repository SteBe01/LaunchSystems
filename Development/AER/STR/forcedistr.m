...
%%% Calcolo dei vari contributi alla forza aerodinamica:

% OSS --> !!!!!!!!!!!!!! alpha in radianti !!!!!!!!!!!!!!!!
...
plot([x(end), x(end)], [a(end)/2, -a(end)/2], 'k', LineWidth=1.75)
axis equal
grid on
set(gca, 'FontSize', 30)
xlabel('x [m]', FontSize=35)
ylabel('y [m]', FontSize=35)
title('Launcher Aero loads', FontSize=40)

quiver(pos_nose(1), pos_nose(2), cF_nose(1), cF_nose(2), LineWidth=2)
quiver(pos_cyl1(1), pos_cyl1(2), cF_cyl1(1), cF_cyl1(2), LineWidth=2)
quiver(pos_sh(1), pos_sh(2), cF_sh(1), cF_sh(2), LineWidth=2)
quiver(pos_cyl2(1), pos_cyl2(2), cF_cyl2(1), cF_cyl2(2), LineWidth=2)
quiver(pos_tail(1), pos_tail(2), cF_tail(1), cF_tail(2), LineWidth=2)
quiver(pos_wing(1), pos_wing(2), cF_wing(1), cF_wing(2), LineWidth=2)

legend('geom', 'geom', 'geom', 'nose', 'cyl1', 'shoulder', 'cyl2', 'tail', 'wing')
