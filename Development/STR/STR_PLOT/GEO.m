...
% M_distr=0;
% M_diff = 0;
GEOMETRY.m1=M_it.pay_effective+M_distr;  % fairing
GEOMETRY.m2=M_remaining_2+M_distr-M_diff;% forward skirt
 GEOMETRY.m3=M2.tot_rp1-M_distr-M_diff; % fuel tank2
GEOMETRY.m4=M2.tot_lox-M_distr-M_diff;% oxygen tank2
GEOMETRY.m5=M2.motor+M_distr-M_diff; %  aft skirt 2
GEOMETRY.m6=M_remaining_1/2 -M_distr-M_diff;% interstage
GEOMETRY.m7=M1.tot_rp1+M_distr-M_diff-9.4577;%  fuel tank1
GEOMETRY.m8=M1.tot_lox+M_distr-M_diff;%  oxygen tank1
GEOMETRY.m9=M_remaining_1/2 +M_distr-M_diff;% aft skirt 1
GEOMETRY.m10=M1.motor+M_distr-M_diff; % engine
