function [X_COM,J_y,MASS] = COM_MoI_Stk1_dummy(M_prop_t,MASS)
...
MASS.b2 = x_dwrd_skirt_s2 -x_fair;
MASS.x_s2 = x_dwrd_skirt_s2;
...
MASS.b3 = L_interstage;
MASS.x_i = x_interstage;
...
MASS.x_fin = COM.Stk1.Fins.x_fins;
...
MASS.m1 = sum([COM.Stk1.Pay.m_pay;COM.Stk1.Fair.m_fair]);
MASS.m2 = sum([COM.Stk1.Frw_struct2.m_parachute_2;COM.Stk1.Prop2_FU.m_prop2_FU;COM.Stk1.Tank2_FU.m_tank2_FU;COM.Stk1.Prop2_OX.m_prop2_OX;COM.Stk1.Tank2_OX.m_tank2_OX;COM.Stk1.Pipes2.m_pipes2;COM.Stk1.Aft_Struct2.m_aft_struct2;COM.Stk1.Engine2.m_engine2]);
MASS.m3 = COM.Stk1.Interstage.m_interstage;
MASS.m4 = sum([COM.Stk1.Prop1_FU.m_prop1_FU;COM.Stk1.Tank1_FU.m_tank1_FU;COM.Stk1.Pipes1.m_pipes1;COM.Stk1.Prop1_OX.m_prop1_OX;COM.Stk1.Tank1_OX.m_tank1_OX;COM.Stk1.Aft_Struct1.m_aft_struct1;COM.Stk1.Engine1.m_engine1;COM.Stk1.Fins.m_fins]);
...
MASS.Stk1.Cone.x_cone = (dot(x_cone_vec,m_cone_vec))/sum(m_cone_vec);
MASS.x_com1=MASS.Stk1.Cone.x_cone;

MASS.Stk1.Cone.m_cone = sum(m_cone_vec);
...
MASS.Stk1.Stage2.x_stage2 = (dot(x_stage2_vec,m_stage2_vec))/sum(m_stage2_vec);

MASS.Stk1.Stage2.m_stage2 = sum(m_stage2_vec);
MASS.x_com2=MASS.Stk1.Stage2.x_stage2;
...
MASS.Stk1.Interstage.x_interstage = (dot(x_interstage_vec,m_interstage_vec))/sum(m_interstage_vec);

MASS.Stk1.Interstage.m_interstage = sum(m_interstage_vec);
MASS.x_com3=MASS.Stk1.Interstage.x_interstage;
...
MASS.Stk1.Stage1.x_stage1 = (dot(x_stage1_vec,m_stage1_vec))/sum(m_stage1_vec);

MASS.Stk1.Stage1.m_stage1 = sum(m_stage1_vec);
MASS.x_com4=MASS.Stk1.Stage1.x_stage1;

MASS.Stk1.Cone.x_final = x_fair;
MASS.Stk1.Stage2.x_final = x_dwrd_skirt_s2;
MASS.Stk1.Interstage.x_final = x_interstage;
MASS.Stk1.Stage1.x_final = x_end;

MASS.Stk1.Cone.L = x_fair;
MASS.Stk1.Stage2.L = x_dwrd_skirt_s2 - x_fair;
MASS.Stk1.Interstage.L = x_interstage - x_dwrd_skirt_s2;
MASS.Stk1.Stage1.L = x_end - x_interstage;
