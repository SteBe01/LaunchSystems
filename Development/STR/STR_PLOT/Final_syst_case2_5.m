function [THICKNESS]= Final_syst_case2_5(GEOMETRY,OUT,FORCES,MAT,AER)
...
P_forces = [P1,P2,P3,P3,P4,P5,P6,P7,P8,P8,P9,P10];
...
x_segments = [b1, b2, b3 ,b4,b5,b6,b7,x_b_com,b8,b9,b10];
x = [0, cumsum(x_segments)]; % Cumulative lengths for plotting

% Axial Forces (P) at segment ends
P_forces = [P1,P2,P3,P4,P5,P6,P7,P8,P8,P10,P10];
...
% Axial Forces (P) at segment ends
P_forces = -[R1,R2,R3,R4,R5,R6,R7,R8,R8,R10,R10];
