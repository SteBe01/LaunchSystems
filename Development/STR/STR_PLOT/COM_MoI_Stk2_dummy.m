function [X_COM,J_y] = COM_MoI_Stk2_dummy(M_prop_t,MASS)
...
MoI.Stk2.Fair.J0_fair = (3/10)*MASS.TR.Fair.M_fair*((Diam_2)^2);
...
MoI.Stk2.Tank2_OX.J0_tank2_OX = (MASS.Tank2.OX.M_tot_tank_lox*((MASS.Tank2.OX.R_cyl_lox)^2)*(1 - t_2O + ((t_2O^2)/2))) + ((4/5)*MASS.Tank2.OX.M_spherical_cap_lox*(MASS.Tank2.OX.R_cyl_lox));
MoI.Stk2.Tank2_FU.J0_tank2_FU = (MASS.Tank2.FU.M_tot_tank_fuel*((MASS.Tank2.FU.R_cyl_fuel)^2)*(1 - t_2F + ((t_2F^2)/2))) + ((4/5)*MASS.Tank2.FU.M_spherical_cap_fuel*(MASS.Tank2.FU.R_cyl_fuel));

elseif strcmp(MASS.Tank2.OX.FLAG, 'Sphere') && strcmp(MASS.Tank2.FU.FLAG, 'Sphere')

MoI.Stk2.Tank2_OX.J0_tank2_OX = (2/5)*(MASS.Tank2.OX.M_tot_tank_lox)*((((MASS.Tank2.OX.R_sphere_lox+ MASS.Tank2.OX.t_lox)^5)-((MASS.Tank2.OX.R_sphere_lox)^5))/(((MASS.Tank2.OX.R_sphere_lox+ MASS.Tank2.OX.t_lox)^3)-((MASS.Tank2.OX.R_sphere_lox)^3))); % [kg*m^2]

MoI.Stk2.Tank2_FU.J0_tank2_FU = (2/5)*(MASS.Tank2.FU.M_tot_tank_fuel)*((((MASS.Tank2.FU.R_sphere_fuel+ MASS.Tank2.FU.t_fuel)^5)-((MASS.Tank2.FU.R_sphere_fuel)^5))/(((MASS.Tank2.FU.R_sphere_fuel+ MASS.Tank2.FU.t_fuel)^3)-((MASS.Tank2.FU.R_sphere_fuel)^3)));% [kg*m^2]
