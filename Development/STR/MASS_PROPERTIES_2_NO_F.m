function [X_COM_t,Jyaw_t,Jpitch_t,Jroll_t,GEOMETRY] = MASS_PROPERTIES_2_NO_F(M_prop_t,GEOMETRY)

m_fair = GEOMETRY.m_fair;
...
if M_prop_t>GEOMETRY.m_prop_2
 ...
 fprintf('Error, too much propellant2F\n');
...
m_vec = [GEOMETRY.m1-m_fair;GEOMETRY.m2;GEOMETRY.m_tank_f_2;m_fuel_2t;GEOMETRY.m_tank_lox_2;m_lox_2t;GEOMETRY.m5];
