function [CLAMP] = ATT_FINAL_PLOT_SUB(GEOMETRY,LOAD,PlotFlag,SaveFlag,h_it,M_it)
...
hold on;
for i = 1:length(x_segments)
    plot([x(i+1), x(i+1)], [0, P_forces_z(i)], '--', 'LineWidth', 1,'Color', 'b'); % Dashed vertical lines
end
stairs(x, [0, P_forces_z] ,'LineWidth', 2, 'Color', 'b'); % Step-style plot
xlabel('x [m]');
