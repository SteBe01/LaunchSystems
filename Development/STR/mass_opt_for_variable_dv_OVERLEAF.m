...
loads.nx = 6; %2; %longitudinal acceleration load factor [-]
loads.nz = 1; %1.1;%transversal acceleration load factor [-]
...
for j = 1:n
    for k = 1:m
        ...
        maxQ = 50000; %21000; %0.5 * rho_air * v^2; %[Pa] maximum dynamic pressure
        ...
        M.nz = loads.nz; %[-] exp transversal load factor
