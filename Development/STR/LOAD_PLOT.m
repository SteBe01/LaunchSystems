...
% [STRUCT]=FINAL_STR_ANALYSIS_T_PLOT_SUB(GEOMETRY,FORCES,2,SaveFlag,h_it_case,M_it_case);
% exportgraphics(gcf,'CARICHI_MPP.pdf', 'ContentType','vector');
%  %% ATTACHMENTS:
PlotFlag =1;
LOAD.Cl=FORCES.Cl;
LOAD.Cd=FORCES.Cd;
...
% [CLAMP] = ATT_FINAL_PLOT_SUB(GEOMETRY,LOAD,PlotFlag,SaveFlag,h_it_case,M_it_case);
% exportgraphics(gcf,'ATTACCHI_MPP.pdf', 'ContentType','vector');
%% 
% DIFF =20;
% PLOT_ROCKET_FULL(M_it_case,h_it_case,DIFF);
% exportgraphics(gcf,'MISSILE.pdf', 'ContentType','vector');